...
_texteV = TextClip("CinEditorML c est egalement du decoupage de videos", fontsize=70, color='white')
_texteV = _texteV.set_position('center').set_duration(10)
texteV = CompositeVideoClip([_texteV], size=[1920, 1080])

### Text 

_texteV9 = TextClip("Ci apres la video qu on va decouper", fontsize=70, color='white')
...
final = concatenate_videoclips([texteV, texteV9, video3], method='compose')
