...
_begin = TextClip(":coeur: Video de présentation de CinEditorML By CinEditorML :coeur:", fontsize=70, color='white')
...
TEMPV = 0 + 5
s5 = TextClip("Enjoy It !!!:feu:", fontsize=70, color='white')
s5 = s5.set_position(('center','bottom')).set_duration(5)
s5 = s5.set_start(TEMPV)


TEMPV = 0 + 10 + 0
s1 = TextClip("Animation de texte ARRIVE :boum:", fontsize=70, color='white')
s1 = s1.set_position(('center','bottom')).set_duration(5)
s1 = s1.set_start(TEMPV)


TEMPV = 0 + 10 + 5 + 0
s2 = TextClip("Animation de texte VORTEX :boum:", fontsize=70, color='white')
s2 = s2.set_position(('center','bottom')).set_duration(5)
s2 = s2.set_start(TEMPV)


TEMPV = 0 + 10 + 5 + 5 + 0
s3 = TextClip("Animation de texte CASCADE :boum:", fontsize=70, color='white')
s3 = s3.set_position(('center','bottom')).set_duration(5)
s3 = s3.set_start(TEMPV)


TEMPV = 0 + 10 + 5 + 5 + 5 + 0
s4 = TextClip("Animation de texte VORTEXOUT :boum:", fontsize=70, color='white')
