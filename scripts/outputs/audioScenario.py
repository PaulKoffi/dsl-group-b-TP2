...
if audio_video1 is None:
    compo = CompositeAudioClip([audio_audio1.set_start(TEMPV).volumex(1.5)])
else:
...
if audio_final is None:
    compo = CompositeAudioClip([audio_audio2.set_start(31).volumex(2.0)])
else:
