...
_begin = TextClip("GeeksforGeeks", fontsize=70, color='white')
_begin = _begin.set_position('center').set_duration(10)
begin = CompositeVideoClip([_begin], size=(720, 460))
letters = findObjects(begin)
begin = CompositeVideoClip(moveLetters(letters, arrive), size=(720, 460)).subclip(0, 10)
...
end = CompositeVideoClip([_end], size=(720, 460))
letters = findObjects(end)
end = CompositeVideoClip(moveLetters(letters, vortex), size=(720, 460)).subclip(0, 10)
