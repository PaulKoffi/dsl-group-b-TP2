...
TEMPV = 0 + 10 + 10
s1 = TextClip(" I m good", fontsize=70, color='white')
s1 = s1.set_position(('center','bottom')).set_duration(20)
s1 = s1.set_start(TEMPV)


TEMPV = 0 + 10 + 10 + 20 + 10
s2 = TextClip(" I m bad", fontsize=70, color='white')
s2 = s2.set_position(('center','bottom')).set_duration(30)
s2 = s2.set_start(TEMPV)


TEMPV = 0 + 10 + int(clip1a.duration) - 5
s3 = TextClip(" I m bad and good", fontsize=70, color='white')
s3 = s3.set_position(('center','bottom')).set_duration(20)
...
final.write_videofile("scenario2.mp4", fps=30)
